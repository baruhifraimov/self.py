...
def main():
    ...
    with open(text_file_path + '\\' + WELCOME_SCREEN_FILE, 'r') as welcome_file:
        # make sure the file path contains the context of variable 'WELCOME_SCREEN_FILE'
        # if not, the application will get an error
    ...
    # make sure the file path contains the context of variable 'DEFAULT_DICTIONARY'
